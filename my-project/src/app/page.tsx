        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="px-4 md:px-16 flex flex-col md:flex-row-reverse">
            <div className="md:w-1/2 my-auto py-12 flex flex-col">
              ...
              <Image src={teamImage} alt="team-image" className="px-4 mt-1 md:self-end object-cover" />
            </div>
            <div className="md:w-1/2 md:py-12 space-y-6 px-4 md:px-20">
              <p className={`${playfairDisplay.variable} font-playfairDisplay font-medium text-3xl hidden md:block`}>My Design Journey</p>
              <div>
